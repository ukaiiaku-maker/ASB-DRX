...
11. The first shared thermomechanical/phase ledger passes for a homogeneous-mechanics binary aggregate. Spatial stress redistribution, heterogeneous temperature and conduction in the same phase domain, recovery, physical boundaries, localization convergence, and calibrated ASB/DRX interaction remain unverified.
