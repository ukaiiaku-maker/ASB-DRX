...
`legacy_controls/hpc3_regressions.json` records the compact, machine-readable results of the fetched and checksum-verified v32/v33/v34 HPC3 controls. The large numerical artifacts remain under the ignored `hpc3-results/asb-drx-independent/<run-id>` tree and on the campaign remote root; both locations are identified by archive and diagnostic hashes.
