...
- The first-pass/repeat-pass distinction has a concrete precedent: a dense-forest glide theory treated the first crossing as requiring constriction while subsequent dislocations encounter an already conditioned forest segment. The result is qualitative and material/mechanism specific, but it shows that repeat transparency would require an internal conditioning/reset state rather than a density-only switch: [Acta Metallurgica 19, 915-921 (1971)](https://doi.org/10.1016/0001-6160(71)90084-8).
- Recent 3-D/topological work shows that glissile reaction products can contribute substantially to hardening despite remaining mobile. Thus “transparent” or shearable cannot be identified with zero strength or automatic softening: [Acta Materialia 268, 119748 (2024)](https://doi.org/10.1016/j.actamat.2024.119748).
