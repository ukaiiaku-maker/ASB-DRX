#!/usr/bin/env python3
"""Bitwise continuous-versus-segmented qualification of the V22 state."""
...
ARRAY_KEYS = (
    ...
    "v22_multi_hit_coordination", "T", "psi_lat", "psi_plastic", "E_tot",
...
def main():
    ...
    print(json.dumps({"fixture_passed": passed,
